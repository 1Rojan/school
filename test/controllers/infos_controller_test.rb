...
class InfosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create info" do
    assert_difference('Info.count') do
      post infos_url, params: { info: { contact: @info.contact, email: @info.email, school_intro: @info.school_intro, school_location: @info.school_location, school_name: @info.school_name } }
    end
  ...
  test "should update info" do
    patch info_url(@info), params: { info: { contact: @info.contact, email: @info.email, school_intro: @info.school_intro, school_location: @info.school_location, school_name: @info.school_name } }
